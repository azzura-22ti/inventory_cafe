...
!(function (t, e) {
    ...
    return (function () {
        ...
        function ft(t) {
            ...
            t = ut(t, e, t / 1e3) ? e : t;
            const i = Math.pow(10, Math.floor(ct(t))),
                s = t / i;
        ...
        function _t(t, e) {
            ...
            return o < -0.5 * it && (o += st), { angle: o, distance: n };
        }
        function yt(t, e) {
        ...
        const Dt = (t, e, i, s) =>
            ...
            Ot = (t, e, i) => Pt(t, i, (s) => t[s][e] >= i),
            Ct = ["push", "pop", "shift", "splice", "unshift"];
        function At(t, e) {
            const i = t._chartjs;
            if (!i) return;
            const s = i.listeners,
                    ...
                    (o = u
                        ? kt(
                              Math.max(
                                  ...
                                  i
                                      ? 0
                                      : Dt(e, l, a.getPixelForValue(c), !0).hi +
                                            1
                              ),
                              n,
                              s
        ...
        const Vt = (t) => 0 === t || 1 === t,
            Bt = (t, e, i) =>
                -Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * st) / i),
            Wt = (t, e, i) =>
                Math.pow(2, -10 * t) * Math.sin(((t - e) * st) / i) + 1,
            Nt = {
                linear: (t) => t,
                easeInQuad: (t) => t * t,
                easeOutQuad: (t) => -t * (t - 2),
                ...
                easeOutElastic: (t) => (Vt(t) ? t : Wt(t, 0.075, 0.3)),
                easeInOutElastic(t) {
                    const e = 0.1125;
                    return Vt(t)
                        ? t
                ...
                easeInBounce: (t) => 1 - Nt.easeOutBounce(1 - t),
                easeOutBounce(t) {
                    const e = 7.5625,
                        i = 2.75;
                    return t < 1 / i
                ...
                easeInOutBounce: (t) =>
                    t < 0.5
                        ...
                        : 0.5 * Nt.easeOutBounce(2 * t - 1) + 0.5,
            };
        function Ht(t) {
        ...
        function qt(t, e, i) {
            return (function (t, e) {
                ...
                let s = Xt.get(i);
                return (
                    s || ((s = new Intl.NumberFormat(t, e)), Xt.set(i, s)), s
                );
            })(e, i).format(t);
        }
        const Kt = {
            ...
            numeric(t, e, i) {
                ...
                return Object.assign(l, this.options.ticks.format), qt(t, s, l);
            },
            logarithmic(t, e, i) {
                if (0 === t) return "0";
                const s =
                    i[e].significand || t / Math.pow(10, Math.floor(ct(t)));
                return [1, 2, 3, 5, 10, 15].includes(s) || e > 0.8 * i.length
                    ? Kt.numeric.call(this, t, e, i)
                    : "";
            },
        };
        ...
        function te(t, e, i) {
            return "string" == typeof e ? X(Qt(t, e), i) : X(Qt(t, ""), e);
        }
        class ee {
            constructor(t, e) {
                ...
                switch ((t.beginPath(), f)) {
                    ...
                    case "rectRounded":
                        (h = 0.516 * p),
                            ...
                            t.arc(i - d, s - r, h, m - it, m - rt),
                            t.arc(i + u, s - a, h, m - rt, m),
                            t.arc(i + d, s + r, h, m, m + rt),
                            t.arc(i - u, s + a, h, m + rt, m + it),
                            t.closePath();
                        break;
                    case "rect":
                        if (!g) {
        ...
        function me(t, e, i, s, n, o = {}) {
            ...
            for (
                ...
                (h = a[l]),
                    o.backdrop && pe(t, o.backdrop),
                    r &&
                        (o.strokeColor && (t.strokeStyle = o.strokeColor),
                        R(o.strokeWidth) || (t.lineWidth = o.strokeWidth),
        ...
        function be(t, e) {
            ...
            t.arc(i + a.topLeft, s + a.topLeft, a.topLeft, -rt, it, !0),
        ...
        function Pe(t, e) {
            ...
            const n = {
                ...
                lineHeight: ye(B(t.lineHeight, e.lineHeight), i),
                size: i,
                style: s,
                ...
                get(i, s) {
                    return Re(i, s, () =>
                        (function (t, e, i, s) {
                            let n;
                            for (const o of e)
                                if (((n = We(Le(o, t), i)), void 0 !== n))
                                    return Ee(t, n) ? Ve(i, s, t, n) : n;
                        })(s, e, t, i)
                    );
                },
        ...
        const ze = (t, e) =>
            !0 === t ? e : "string" == typeof t ? Z(e, t) : void 0;
        ...
        function Ve(t, e, i, s) {
            const n = e._rootScopes,
                ...
                r = new Set();
            r.add(s);
            let l = Be(r, a, i, o || i, s);
            return (
                null !== l &&
                (void 0 === o ||
                    o === i ||
                    ((l = Be(r, a, o, l, s)), null !== l)) &&
                Ce(Array.from(r), [""], n, o, () =>
                    (function (t, e, i) {
        ...
        function He(t, e, i, s) {
            ...
            let r, l, h, c;
            for (r = 0, l = s; r < l; ++r)
                (h = r + i), (c = e[h]), (a[r] = { r: n.parse(Z(c, o), h) });
            return a;
        }
                    ...
                    for (i = 0, s = t.length; i < s; ++i)
                        (a = o),
                            ...
                            o &&
                                ((n = t[i]),
                                a &&
                                    ((n.cp1x = Xe(n.cp1x, e.left, e.right)),
                                    (n.cp1y = Xe(n.cp1y, e.top, e.bottom))),
                                r &&
                                    ((n.cp2x = Xe(n.cp2x, e.left, e.right)),
                                    (n.cp2y = Xe(n.cp2y, e.top, e.bottom))));
                })(t, i);
        }
        function Ke() {
            return (
        ...
        const ei = (t, e, i) => (t > 0 || e > 0) && (!i || !i.shadowRoot);
        function ii(t, e) {
        ...
        function fi(t) {
            return "angle" === t
                ? { between: wt, compare: vt, normalize: Mt }
                : {
                      between: St,
                      compare: (t, e) => t - e,
                      normalize: (t) => t,
        ...
        function gi({ start: t, end: e, count: i, loop: s, style: n }) {
            return {
                start: t % i,
                end: e % i,
                loop: s && (e - t + 1) % i == 0,
        ...
        function pi(t, e, i) {
            ...
            return (
                null !== _ &&
                    g.push(
                        gi({ start: _, end: d, loop: u, count: a, style: f })
                    ),
                g
            );
        }
        ...
        class wi {
            constructor(t, e, i, s) {
                ...
                (this._active = !0),
                    (this._fn = t.fn || Mi[t.type || typeof o]),
                    (this._easing = Nt[t.easing] || Nt.linear),
            ...
            update(t, e, i) {
                if (this._active) {
                    ...
                    (this._start = i),
                        ...
                        (this._total += n),
                        (this._loop = !!t.loop),
                        (this._to = De([t.to, e, s, t.from])),
                        (this._from = De([t.from, s, e]));
                }
            }
            cancel() {
                this._active &&
        ...
        class ki {
            ...
            configure(t) {
                ...
                Object.getOwnPropertyNames(t).forEach((s) => {
                    ...
                    ((I(n.properties) && n.properties) || [s]).forEach((t) => {
        ...
        function Ti(t, e) {
            ...
            for (let t = 0; t < d; ++t) {
                const i = e[t],
                    { [l]: o, [h]: d } = i;
                (u = (i._stacks || (i._stacks = {}))[h] = Ci(n, c, o)),
                    (u[r] = d),
                    (u._top = Ai(u, a, !0, s.type)),
                    (u._bottom = Ai(u, a, !1, s.type)),
        ...
        class zi {
            ...
            _destroy() {
                const t = this._cachedMeta;
                this._data && At(this._data, this), t._stacked && Ei(t);
            }
            _dataCheck() {
            ...
            buildOrUpdateElements(t) {
                ...
                this._dataCheck();
                const n = e._stacked;
                (e._stacked = Oi(e.vScale, e)),
                    e.stack !== i.stack &&
                        ((s = !0), Ei(e), (e.stack = i.stack)),
                    this._resyncElements(t),
                    (s || n !== e._stacked) && Ti(this, e._parsed);
            }
            configure() {
            ...
            updateRangeFromParsed(t, e, i, s) {
                ...
                s &&
                    a &&
                    ((s.values = a), (o = Di(s, n, this._cachedMeta.index))),
            ...
            getMinMax(t, e) {
                ...
                function f() {
                    u = s[d];
                    const e = u[a.axis];
                    return !F(u[t.axis]) || h > e || c < e;
                }
                for (
                    d = 0;
                    d < o &&
                    (f() || (this.updateRangeFromParsed(l, t, u, r), !n));
                    ++d
                );
                if (n)
                    for (d = o - 1; d >= 0; --d)
            ...
            _resolveElementOptions(t, e = "default", i) {
                const s = "active" === e,
                    ...
                    o = t + "-" + e,
                    a = n[o],
                    r = this.enableOptionSharing && Q(i);
                if (a) return Ii(a, r);
                const l = this.chart.config,
                    h = l.datasetElementScopeKeys(this._type, t),
                    c = s ? [`${t}Hover`, "hover", t, ""] : [t, ""],
                    d = l.getOptionScopes(this.getDataset(), h),
                    u = Object.keys(ie.elements[t]),
                ...
                return (
                    f.$shared &&
                        ((f.$shared = r), (n[o] = Object.freeze(Ii(f, r)))),
                    f
                );
            }
            _resolveAnimations(t, e, i) {
                ...
                const l = new ki(s, r && r.animations);
            ...
            updateSharedOptions(t, e, i) {
                t && !Ri(e) && this._resolveAnimations(void 0, e).update(t, i);
            }
            _setStyle(t, e, i, s) {
                t.active = s;
        ...
        function Fi(t) {
            ...
            const l = () => {
                32767 !== o &&
                    -32768 !== o &&
                    (Q(a) && (r = Math.min(r, Math.abs(o - a) || r)), (a = o));
            };
        ...
        function $i(t, { inflateAmount: e }, i) {
        ...
        class Yi extends zi {
            ...
            update(t) {
                const e = this.chart,
                    ...
                    r = Math.min(
                        ((h = a),
                        "string" == typeof (l = this.options.cutout) &&
                        l.endsWith("%")
                            ? parseFloat(l) / 100
                            : +l / h),
                        1
            ...
            _circumference(t, e) {
                ...
                return (e && i.animation.animateRotate) ||
                    ...
                    s.data[t].hidden
                    ? 0
                    : this.calculateCircumference((s._parsed[t] * n) / st);
            }
            updateElements(t, e, i, s) {
                const n = "reset" === s,
                    o = this.chart,
            ...
            getLabelAndValue(t) {
                const e = this._cachedMeta,
                    i = this.chart,
                    s = i.data.labels || [],
                    n = qt(e._parsed[t], i.options.locale);
        ...
        class Ui extends zi {
            ...
            getLabelAndValue(t) {
                const e = this._cachedMeta,
                    i = this.chart,
                    s = i.data.labels || [],
                    n = qt(e._parsed[t].r, i.options.locale);
                return { label: s[t] || "", value: n };
            }
            parseObjectData(t, e, i, s) {
        ...
        var Xi = Object.freeze({
            __proto__: null,
            BarController: class extends zi {
                static id = "bar";
                static defaults = {
                    datasetElementType: !1,
                    dataElementType: "bar",
                ...
                parseObjectData(t, e, i, s) {
                    ...
                    for (d = i, u = i + s; d < u; ++d)
                        (g = e[d]),
                            (f = {}),
                            (f[n.axis] = n.parse(Z(g, l), d)),
                            c.push(Vi(Z(g, h), f, o, d));
                    return c;
                }
                updateRangeFromParsed(t, e, i, s) {
                ...
                _calculateBarValuePixels(t) {
                    ...
                    if (m === e.getPixelForValue(a)) {
                        const t = (dt(d) * e.getLineWidthForValue(a)) / 2;
                        (m += t), (d -= t);
                    }
            ...
            BubbleController: class extends zi {
                static id = "bubble";
                static defaults = {
                    datasetElementType: !1,
            ...
            LineController: class extends zi {
                static id = "line";
                static defaults = {
                ...
                updateElements(t, e, i, s) {
                    const n = "reset" === s,
                        ...
                        { sharedOptions: h, includeOptions: c } =
                            this._getSharedOptions(e, s),
                        d = o.axis,
                        u = a.axis,
                        { spanGaps: f, segment: g } = this.options,
                        p = gt(f) ? f : Number.POSITIVE_INFINITY,
            ...
            PieController: class extends Yi {
                static id = "pie";
                static defaults = {
                    cutout: 0,
                    rotation: 0,
            ...
            RadarController: class extends zi {
                static id = "radar";
                static defaults = {
                    datasetElementType: "line",
                    dataElementType: "point",
            ...
            ScatterController: class extends zi {
                static id = "scatter";
                static defaults = {
                    datasetElementType: !1,
                    dataElementType: "point",
        ...
        function Zi(t, e, i, s) {
            ...
            if (r && e === r.axis && "r" !== e && a && o.length) {
                const t = r._reversePixels ? Ot : Dt;
                if (!s) return t(o, e, i);
                if (n._sharedOptions) {
                    const s = o[0],
            ...
            modes: {
                ...
                nearest(t, e, i, s) {
                    const n = ii(e, t),
                        o = i.axis || "xy",
                        a = i.includeInvisible || !1;
                    return ts(t, n, o, i.intersect, s, a);
                },
                x(t, e, i, s) {
                    return es(t, ii(e, t), "x", i.intersect, s);
                },
                y(t, e, i, s) {
                    return es(t, ii(e, t), "y", i.intersect, s);
                },
            },
        };
        const ss = ["left", "top", "right", "bottom"];
        function ns(t, e) {
            return t.filter((t) => t.pos === e);
        }
        function os(t, e) {
            return t.filter(
                (t) => -1 === ss.indexOf(t.pos) && t.box.axis === e
            );
        }
        function as(t, e) {
            return t.sort((t, i) => {
        ...
        function hs(t, e, i, s) {
            ...
            const r = Math.max(0, e.outerWidth - rs(a, t, "left", "right")),
                l = Math.max(0, e.outerHeight - rs(a, t, "top", "bottom")),
                h = r !== t.w,
                c = l !== t.h;
            return (
                (t.w = r),
        ...
        function ds(t, e, i, s) {
            ...
            for (o = 0, a = t.length, h = 0; o < a; ++o) {
                ...
                const { same: a, other: d } = hs(e, i, r, s);
        ...
        function Os(t, e, i) {
            ...
            return (
                a.observe(n),
                (function (t, e) {
                    Ss.size || window.addEventListener("resize", Ds),
                        Ss.set(t, e);
                })(t, o),
                a
            );
        ...
        function Cs(t, e, i) {
            i && i.disconnect(),
                "resize" === e &&
                    (function (t) {
                        Ss.delete(t),
                            Ss.size || window.removeEventListener("resize", Ds);
                    })(t);
        }
        function As(t, e, i) {
            const s = t.canvas,
        ...
        class Ts extends ps {
            ...
            addEventListener(t, e, i) {
                ...
                const s = t.$proxies || (t.$proxies = {}),
                    n = { attach: ws, detach: ks, resize: Os }[e] || As;
                s[e] = n(t, e, i);
            }
            removeEventListener(t, e) {
                const i = t.$proxies || (t.$proxies = {}),
                    s = i[e];
                s &&
                    (({ attach: Cs, detach: Cs, resize: Cs }[e] || vs)(t, e, s),
                    (i[e] = void 0));
            }
            getDevicePixelRatio() {
            ...
            getMaximumSize(t, e, i, s) {
                return (function (t, e, i, s) {
                    const n = Je(t),
                        o = ti(n, "margin"),
                        a = Ze(n.maxWidth, t, "clientWidth") || ot,
                        r = Ze(n.maxHeight, t, "clientHeight") || ot,
                        l = (function (t, e, i) {
                            let s, n;
                    ...
                    return (
                        ...
                        (h = si(Math.min(h, a, l.maxWidth))),
                        (c = si(Math.min(c, r, l.maxHeight))),
                        h && !c && (c = si(h / 2)),
                        (void 0 !== e || void 0 !== i) &&
                            s &&
                            l.height &&
                            c > l.height &&
                            ((c = l.height), (h = si(Math.floor(c * s)))),
                        { width: h, height: c }
                    );
                })(t, e, i, s);
            }
        ...
        function Bs(t, e) {
            ...
            const i = Pe(t.font, e),
                s = Se(t.padding);
            return (I(t.text) ? t.text.length : 1) * i.lineHeight + s.height;
        }
        function Ws(t, e, i) {
            let s = Rt(t);
            return (
        ...
        class Ns extends Ls {
            ...
            getUserBounds() {
                ...
                return (
                    ...
                    (s = V(s, Number.NEGATIVE_INFINITY)),
                    {
                        min: V(t, i),
                        max: V(e, s),
                        minDefined: F(t),
            ...
            generateTickLabels(t) {
                ...
                for (i = 0, s = t.length; i < s; i++)
                    (n = t[i]),
                        (n.label = N(e.callback, [n.value, i, t], this));
            }
            ...
            calculateLabelRotation() {
                const t = this.options,
                    e = t.ticks,
                    i = Is(this.ticks.length, t.ticks.maxTicksLimit),
                    s = e.minRotation || 0,
                    n = e.maxRotation;
                let o,
                    a,
                ...
                const h = this._getLabelSizes(),
                    c = h.widest.width,
                    d = h.highest.height,
                    u = kt(this.chart.width - c, 0, this.maxWidth);
                (o = t.offset ? this.maxWidth / i : u / (i - 1)),
                    c + 6 > o &&
                        ...
                        (l = bt(
                            Math.min(
                                Math.asin(
                                    kt((h.highest.height + 6) / o, -1, 1)
                                ),
                                Math.asin(kt(a / r, -1, 1)) -
                                    Math.asin(kt(d / r, -1, 1))
                            )
                        )),
                        ...
                        if (I(d))
                            for (h = 0, c = d.length; h < c; ++h)
                                (x = d[h]),
                                    R(x) ||
                                        I(x) ||
                                        ((m = se(s, g.data, g.gc, m, x)),
                                        (b += p));
                    } else (m = se(s, g.data, g.gc, m, d)), (b = p);
                    o.push(m),
                        a.push(b),
                        (_ = Math.max(m, _)),
                        (y = Math.max(b, y));
            ...
            getPixelForDecimal(t) {
                ...
                return kt(
                    this._alignToPixels ? oe(this.chart, e, 0) : e,
                    -32768,
                    32767
                );
            }
            ...
            _computeGridLineItems(t) {
                ...
                const O = B(s.ticks.maxTicksLimit, h),
                    C = Math.max(1, Math.ceil(h / O));
                for (b = 0; b < h; b += C) {
            ...
            drawLabels(t) {
                ...
                for (const t of s) {
                    const i = t.options,
                        s = t.font;
                    me(e, t.label, 0, t.textOffset, s, i);
                }
                i && de(e);
            }
            drawTitle() {
                ...
                "bottom" === e || "center" === e || z(e)
                    ? ((r += o.bottom),
                      I(i.text) && (r += n.lineHeight * (i.text.length - 1)))
                    : (r += o.top);
                const {
                    titleX: l,
                    titleY: h,
        ...
        class Hs {
            ...
            unregister(t) {
                ...
                i in e && delete e[i],
                    s &&
                        i in ie[s] &&
                        (delete ie[s][i], this.override && delete Zt[i]);
            }
        }
        class js {
            constructor() {
                (this.controllers = new Hs(zi, "datasets", !0)),
                    (this.elements = new Hs(Ls, "elements")),
                    (this.plugins = new Hs(Object, "plugins")),
                    (this.scales = new Hs(Ns, "scales")),
        ...
        class Ys {
            ...
            _notify(t, e, i, s) {
                ...
                for (const n of t) {
                    const t = n.plugin;
                    if (!1 === N(t[i], [e, s, n.options], t) && s.cancelable)
                        return !1;
                }
                return !0;
            }
            ...
            _createDescriptors(t, e) {
                const i = t && t.config,
                    ...
                    n = (function (t) {
                        const e = {},
                            i = [],
                            s = Object.keys($s.plugins.items);
                        for (let t = 0; t < s.length; t++)
                            i.push($s.getPlugin(s[t]));
                        const n = t.plugins || [];
                        for (let t = 0; t < n.length; t++) {
                            const s = n[t];
        ...
        function Xs(t, { plugin: e, local: i }, s, n) {
        ...
        class on {
            ...
            getOptionScopes(t, e, i) {
                ...
                e.forEach((e) => {
                    t && (r.add(t), e.forEach((e) => nn(r, t, e))),
                        ...
                        e.forEach((t) => nn(r, Zt[n] || {}, t)),
                        e.forEach((t) => nn(r, ie, t)),
                        e.forEach((t) => nn(r, Jt, t));
                });
            ...
            resolveNamedOptions(t, e, i, s = [""]) {
                ...
                let r = o;
                (function (t, e) {
                    const { isScriptable: i, isIndexable: s } = Te(t);
                    for (const n of e) {
                        const e = i(n),
                            o = s(n),
                            a = (o || e) && t[n];
                        if ((e && (tt(a) || rn(a))) || (o && I(a))) return !0;
                    }
                    return !1;
                })(o, e) &&
                    ((n.$shared = !1),
        ...
        class bn {
            ...
            constructor(t, e) {
                ...
                (this.id = E()),
                    ...
                    (gn[this.id] = this),
                    a && r
                        ? (yi.listen(this, "complete", dn),
                          yi.listen(this, "progress", un),
                          this._initialize(),
            ...
            buildOrUpdateScales() {
                ...
                e &&
                    ...
                    H(i, (t) => {
                        gs.configure(this, t, t.options), gs.addBox(this, t);
                    });
            }
            _updateMetasets() {
            ...
            buildOrUpdateControllers() {
                ...
                for (
                    ...
                    if (
                        ...
                        const e = $s.getController(o),
                            { datasetElementType: s, dataElementType: a } =
                                ie.datasets[o];
                        Object.assign(e, {
                            dataElementType: $s.getElement(a),
                            datasetElementType: s && $s.getElement(s),
                        }),
            ...
            _checkEventBindings() {
                const t = this.options,
                    ...
                    i = new Set(t.events);
                (et(e, i) && !!this._responsiveListeners === t.responsive) ||
            ...
            _getUniformDataChanges() {
                ...
                const e = this.data.datasets.length,
                    ...
                    s = i(0);
                for (let t = 1; t < e; t++) if (!et(s, i(t))) return;
                return Array.from(s)
                    .map((t) => t.split(","))
            ...
            _updateLayout(t) {
                if (
                    ...
                    return;
                gs.update(this, this.width, this.height, t);
            ...
            _handleEvent(t, e, i) {
                ...
                i &&
                    ((this._lastEvent = null),
                    N(n.onHover, [t, a, this], this),
                    r && N(n.onClick, [t, a, this], this));
                const h = !j(a, s);
                return (
                    (h || e) &&
        ...
        function xn() {
            return H(bn.instances, (t) => t._plugins.invalidate());
        }
        function _n(t, e, i, s) {
        ...
        function yn(t, e, i, s, n, o) {
            ...
            const p = (g - Math.max(0.001, g * d - i / it) / d) / 2,
                m = l + p + f,
                b = n - p - f,
                {
                    outerStart: x,
                    ...
                    const n = Me(t.options.borderRadius, [
                        ...
                        r = (t) => {
                            ...
                            return kt(t, 0, Math.min(o, e));
                        };
                    return {
                        outerStart: r(n.outerStart),
                        outerEnd: r(n.outerEnd),
                        innerStart: kt(n.innerStart, 0, a),
                        innerEnd: kt(n.innerEnd, 0, a),
                    };
                })(e, u, d, b - m),
                M = d - x,
                w = d - _,
            ...
            if ((t.beginPath(), o)) {
                ...
                if ((t.arc(a, r, d, k, e), t.arc(a, r, d, e, S), _ > 0)) {
                    const e = _n(w, S, a, r);
                    t.arc(e.x, e.y, _, S, b + rt);
                }
                const i = _n(D, b, a, r);
                if ((t.lineTo(i.x, i.y), v > 0)) {
                    const e = _n(D, C, a, r);
                    t.arc(e.x, e.y, v, b + rt, C + Math.PI);
                }
                ...
                if (
                    ...
                    const e = _n(P, O, a, r);
                    t.arc(e.x, e.y, y, O + Math.PI, m - rt);
                }
                const n = _n(M, m, a, r);
                if ((t.lineTo(n.x, n.y), x > 0)) {
                    const e = _n(M, k, a, r);
                    t.arc(e.x, e.y, x, m - rt, k);
                }
            } else {
                t.moveTo(a, r);
        ...
        function Ln(t, e, i, s) {
            ...
            return (
                a &&
                (n || St(e, a.left, a.right)) &&
                (o || St(i, a.top, a.bottom))
            );
        }
        function En(t, e) {
        ...
        var In = Object.freeze({
            ...
            ArcElement: class extends Ls {
                ...
                inRange(t, e, i) {
                    const s = this.getProps(["x", "y"], i),
                        { angle: n, distance: o } = _t(s, { x: t, y: e }),
                        {
                            startAngle: a,
                            endAngle: r,
                            innerRadius: l,
                ...
                draw(t) {
                    ...
                    if (
                        ...
                        (this.fullCircles = i > st ? Math.floor(i / st) : 0),
                    ...
                    const r = s * (1 - Math.sin(Math.min(it, i || 0)));
                            ...
                            f &&
                                (function (t, e, i) {
                                    ...
                                    t.beginPath(),
                                        ...
                                        l > n
                                            ? ((h = n / l),
                                              t.arc(o, a, l, i + h, s - h, !0))
                                            : t.arc(o, a, n, i + rt, s - rt),
                                        t.closePath(),
                                        t.clip();
                                })(t, e, g),
            ...
            BarElement: class extends Ls {
                ...
                inXRange(t, e) {
                    return Ln(this, t, null, e);
                }
                inYRange(t, e) {
                    return Ln(this, null, t, e);
                }
                getCenterPoint(t) {
                    const {
                        x: e,
            ...
            PointElement: class extends Ls {
                ...
                draw(t, e) {
                    ...
                    this.skip ||
                        i.radius < 0.1 ||
                        !he(this, e, this.size(i) / 2) ||
                        ((t.strokeStyle = i.borderColor),
                        (t.lineWidth = i.borderWidth),
                        (t.fillStyle = i.backgroundColor),
                        re(t, i, this.x, this.y));
                }
                getRange() {
                    const t = this.options || {};
                ...
                t.data.datasets.forEach((e, n) => {
                    ...
                    let c,
                        { start: d, count: u } = (function (t, e) {
                            ...
                            return (
                                l && (n = kt(Dt(e, o.axis, a).lo, 0, i - 1)),
                                (s = h
                                    ? kt(Dt(e, o.axis, r).hi + 1, n, i) - n
                                    : i - n),
                                { start: n, count: s }
                            );
                        })(r, l);
                    if (u <= (i.threshold || 4 * s)) Hn(e);
                    else {
                        switch (
                            (R(o) &&
                                ((e._data = l),
        ...
        function Zn(t, e, i) {
            ...
            if (z(s)) return !isNaN(s.value) && s;
            let n = parseFloat(s);
            return F(n) && Math.floor(n) === n
                ? (function (t, e, i, s) {
                      return (
                          ("-" !== t && "+" !== t) || (i = e + i),
                          !(i === e || i < 0 || i >= s) && i
            ...
            const s = (function (t) {
                    ...
                    if ("stack" === i)
                        return (function (t) {
                            ...
                            r.push(qn({ x: null, y: e.bottom }, s));
                            for (let t = 0; t < o.length; t++) {
                                const e = o[t];
                                for (let t = e.start; t <= e.end; t++)
                                    Jn(n, a[t], r);
                            }
                            return new On({ points: n, options: {} });
                        })(t);
                    if ("shape" === i) return !0;
                    const n = (function (t) {
                        return (t.scale || {}).getPointPositionForValue
                            ? (function (t) {
                                  const { scale: e, fill: i } = t,
                                      ...
                                      r = [];
                                  if (s.grid.circular) {
                                      const t = e.getPointPositionForValue(
                                          0,
                                          o
                                      );
                                      return new to({
                    ...
                    return n instanceof to ? n : qn(n, s);
                })(e),
            ...
            const { line: i, target: s, property: n, color: o, scale: a } = e,
                r = (function (t, e, i) {
                    ...
                    for (const t of s) {
                        ...
                        const h = mi(e, l);
                        for (const e of h) {
                            const s = Yn(i, o[e.start], o[e.end], e.loop),
                                r = pi(t, n, s);
                            for (const t of r)
                                a.push({
                                    source: t,
                                    target: e,
                                    start: { [i]: Xn(l, s, "start", Math.max) },
                                    end: { [i]: Xn(l, s, "end", Math.min) },
                                });
                        }
                    }
                    return a;
        ...
        var ao = {
            ...
            afterDatasetsUpdate(t, e, i) {
                ...
                for (a = 0; a < s; ++a)
                    (l = n[a]),
                        l && !1 !== l.fill && (l.fill = Gn(n, a, i.propagate));
            },
            beforeDraw(t, e, i) {
        ...
        class lo extends Ls {
            ...
            buildLabels() {
                ...
                let e = N(t.generateLabels, [this.chart], this) || [];
            ...
            fit() {
                ...
                const i = t.labels,
                    ...
                    { boxWidth: a, itemHeight: r } = ro(i, n);
                let l, h;
                (e.font = s.string),
                    this.isHorizontal()
                        ? ((l = this.maxWidth),
            ...
            _draw() {
                const {
                    ...
                    { align: n, labels: o } = t,
                    a = ie.color,
                    r = ci(t.rtl, this.left, this.width),
                    l = Pe(o.font),
                    { padding: h } = o,
                    c = l.size,
                    d = c / 2;
                ...
                this.drawTitle(),
                    ...
                    (s.lineWidth = 0.5),
                    (s.font = l.string);
                const { boxWidth: f, boxHeight: g, itemHeight: p } = ro(o, c),
                    m = this.isHorizontal(),
                    b = this._computeTitleHeight();
                (u = m
                    ? {
                          x: It(n, this.left + h, this.right - i[0]),
                          y: this.top + h + b,
                          line: 0,
                      }
                    : {
                          x: this.left + h,
                          y: It(n, this.top + b + h, this.bottom - e[0].height),
                          line: 0,
                      }),
                    ...
                    if (
                        ...
                        m
                            ? y > 0 &&
                              ...
                              u.line++,
                              (k = u.x =
                                  It(n, this.left + h, this.right - i[u.line])))
                            : y > 0 &&
                              S + x > this.bottom &&
            ...
            _getLegendItemAt(t, e) {
                let i, s, n;
                if (
                    St(t, this.left, this.right) &&
                    St(e, this.top, this.bottom)
                )
                    for (n = this.legendHitBoxes, i = 0; i < n.length; ++i)
                        if (
                            ((s = n[i]),
                            St(t, s.left, s.left + s.width) &&
                                St(e, s.top, s.top + s.height))
                        )
                    ...
                    const o = this._hoveredItem,
                        a =
                            ...
                            null !== (s = o) &&
                                ...
                                s.index === n.index);
                    o && !a && N(e.onLeave, [t, o, this], this),
                        (this._hoveredItem = i),
                        i && !a && N(e.onHover, [t, i, this], this);
                } else i && N(e.onClick, [t, i, this], this);
                var s, n;
            }
        }
        function ho(t, e) {
        ...
        var co = {
            ...
            _element: lo,
            start(t, e, i) {
                const s = (t.legend = new lo({
                    ctx: t.ctx,
                    options: i,
                    chart: t,
                }));
                gs.configure(t, s, i), gs.addBox(t, s);
            },
            stop(t) {
                gs.removeBox(t, t.legend), delete t.legend;
            },
            beforeUpdate(t, e, i) {
                const s = t.legend;
                gs.configure(t, s, i), (s.options = i);
            },
            afterUpdate(t) {
                const e = t.legend;
        ...
        class uo extends Ls {
            ...
            update(t, e) {
                ...
                const s = I(i.text) ? i.text.length : 1;
        ...
        var fo = {
            ...
            start(t, e, i) {
                !(function (t, e) {
                    const i = new uo({ ctx: t.ctx, options: e, chart: t });
                    gs.configure(t, i, e), gs.addBox(t, i), (t.titleBlock = i);
                })(t, i);
            },
            stop(t) {
                const e = t.titleBlock;
                gs.removeBox(t, e), delete t.titleBlock;
            },
            beforeUpdate(t, e, i) {
        ...
        var po = {
            id: "subtitle",
            start(t, e, i) {
                const s = new uo({ ctx: t.ctx, options: i, chart: t });
                gs.configure(t, s, i), gs.addBox(t, s), go.set(t, s);
            },
            stop(t) {
                gs.removeBox(t, go.get(t)), go.delete(t);
            },
            beforeUpdate(t, e, i) {
                const s = go.get(t);
                gs.configure(t, s, i), (s.options = i);
        ...
        function bo(t, e) {
            return (
                e && (I(e) ? Array.prototype.push.apply(t, e) : t.push(e)), t
            );
        }
        function xo(t) {
        ...
        function yo(t, e) {
            ...
            return (
                ...
                H(t.title, _),
                (i.font = l.string),
                H(t.beforeBody.concat(t.afterBody), _),
                (x = e.displayColors ? a + 2 + e.boxPadding : 0),
                H(s, (t) => {
                    H(t.before, _), H(t.lines, _), H(t.after, _);
                }),
                (x = 0),
                (i.font = c.string),
                H(t.footer, _),
        ...
        function wo(t, e, i, s) {
            ...
            return (
                ...
                {
                    x: kt(g, 0, s.width - e.width),
                    y: kt(p, 0, s.height - e.height),
                }
            );
        }
        function ko(t, e, i) {
        ...
        function Oo(t, e, i, s) {
            ...
            return void 0 === n ? Do[e].call(i, s) : n;
        }
        class Co extends Ls {
            static positioners = mo;
            constructor(t) {
                super(),
                    (this.opacity = 0),
                    (this._active = []),
            ...
            getTitle(t, e) {
                const { callbacks: i } = e,
                    s = Oo(i, "beforeTitle", this, t),
                    n = Oo(i, "title", this, t),
                    o = Oo(i, "afterTitle", this, t);
                let a = [];
                return (
                    (a = bo(a, xo(s))),
                    (a = bo(a, xo(n))),
            ...
            getBeforeBody(t, e) {
                return So(Oo(e.callbacks, "beforeBody", this, t));
            }
            getBody(t, e) {
                const { callbacks: i } = e,
                    s = [];
                return (
                    H(t, (t) => {
                        const e = { before: [], lines: [], after: [] },
                            n = Po(i, t);
                        bo(e.before, xo(Oo(n, "beforeLabel", this, t))),
                            bo(e.lines, Oo(n, "label", this, t)),
                            bo(e.after, xo(Oo(n, "afterLabel", this, t))),
                            s.push(e);
                    }),
                    s
                );
            ...
            getAfterBody(t, e) {
                return So(Oo(e.callbacks, "afterBody", this, t));
            }
            getFooter(t, e) {
                const { callbacks: i } = e,
                    s = Oo(i, "beforeFooter", this, t),
                    n = Oo(i, "footer", this, t),
                    o = Oo(i, "afterFooter", this, t);
                let a = [];
                return (
                    (a = bo(a, xo(s))),
                    (a = bo(a, xo(n))),
            ...
            _createItems(t) {
                ...
                for (a = 0, r = e.length; a < r; ++a)
                    l.push(_o(this.chart, e[a]));
                return (
                    t.filter &&
                        (l = l.filter((e, s, n) => t.filter(e, s, n, i))),
                    t.itemSort && (l = l.sort((e, s) => t.itemSort(e, s, i))),
                    H(l, (e) => {
                        const i = Po(t.callbacks, e);
                        s.push(Oo(i, "labelColor", this, e)),
                            n.push(Oo(i, "labelPointStyle", this, e)),
                            o.push(Oo(i, "labelTextColor", this, e));
                    }),
                    (this.labelColors = s),
            ...
            update(t, e) {
                ...
                let n,
                    o = [];
                if (s.length) {
                    const t = mo[i.position].call(this, s, this._eventPosition);
            ...
            drawBody(t, e, i) {
                ...
                let d = c.lineHeight,
                    u = 0;
                const f = ci(i.rtl, this.x, this.width),
                    g = function (i) {
        ...
        var Ao = {
                ...
                positioners: mo,
                afterInit(t, e, i) {
                    i && (t.tooltip = new Co({ chart: t, options: i }));
                },
                beforeUpdate(t, e, i) {
        ...
        function Eo(t, e, { horizontal: i, minRotation: s }) {
            const n = mt(s),
            ...
            buildTicks() {
                ...
                const s = (function (t, e) {
                    ...
                    let y,
                        ...
                        k = ft((p - g) / f / u) * u;
                    if (k < 1e-14 && !m && !b)
                        return [{ value: g }, { value: p }];
                    (w = Math.ceil(p / k) - Math.floor(g / k)),
                        w > f && (k = ft((w * k) / f / u) * u),
                        R(r) ||
                            ((y = Math.pow(10, r)), (k = Math.ceil(k * y) / y)),
                        "ticks" === s
                            ? ((v = Math.floor(g / k) * k),
                              (M = Math.ceil(p / k) * k))
                            : ((v = g), (M = p)),
                        ...
                        (function (t, e) {
                            ...
                            ? ((v = m ? o : v),
                              ...
                              (k = (M - v) / w))
                            : ((w = (M - v) / k),
                              (w = ut(w, Math.round(w), k / 1e3)
                                  ? Math.round(w)
                                  : Math.ceil(w)));
                    const S = Math.max(xt(k), xt(v));
                    (y = Math.pow(10, R(r) ? S : r)),
                        (v = Math.round(v * y) / y),
                        (M = Math.round(M * y) / y);
                    let P = 0;
                    for (
                    ...
                    return (
                        b && d && M !== a
                            ? i.length &&
                              ut(i[i.length - 1].value, a, Eo(a, _, t))
                ...
                return (
                    "ticks" === t.bounds && pt(s, this, "value"),
                    t.reverse
                        ? (s.reverse(),
                          (this.start = this.max),
                          (this.end = this.min))
        ...
        const zo = (t) => Math.floor(ct(t)),
            Fo = (t, e) => Math.pow(10, zo(t) + e);
        function Vo(t) {
            return 1 == t / Math.pow(10, zo(t));
        }
        function Bo(t, e, i) {
        ...
        class Wo extends Ns {
            ...
            parse(t, e) {
                const i = Ro.prototype.parse.apply(this, [t, e]);
            ...
            handleTickRangeOptions() {
                ...
                const n = (e) => (i = t ? i : e),
                    o = (t) => (s = e ? s : t);
                i === s &&
                    (i <= 0 ? (n(1), o(10)) : (n(Fo(i, -1)), o(Fo(s, 1)))),
                    i <= 0 && n(Fo(s, -1)),
                    s <= 0 && o(Fo(i, 1)),
                    (this.min = i),
                    (this.max = s);
                ...
                const t = this.options,
                    e = (function (t, { min: e, max: i }) {
                        ...
                        let d = Math.floor((h - c) / Math.pow(10, o)),
                            u = V(
                                t.min,
                                Math.round((l + c + d * Math.pow(10, o)) * a) /
                                    a
                            );
                        for (; u < i; )
                            s.push({ value: u, major: Vo(u), significand: d }),
                                ...
                                (u =
                                    Math.round(
                                        (l + c + d * Math.pow(10, o)) * a
                                    ) / a);
                        const f = V(t.max, u);
                        return (
                            s.push({ value: f, major: Vo(f), significand: d }),
                            s
                        );
                    })({ min: this._userMin, max: this._userMax }, this);
                return (
                    "ticks" === t.bounds && pt(e, this, "value"),
                    t.reverse
                        ? (e.reverse(),
                          (this.start = this.max),
                          (this.end = this.min))
            ...
            configure() {
                const t = this.min;
                super.configure(),
                    (this._startValue = ct(t)),
                    (this._valueRange = ct(this.max) - ct(t));
            }
            getPixelForValue(t) {
                return (
        ...
        function Uo(t, e, i) {
            const { left: s, top: n, right: o, bottom: a } = i,
                { backdropColor: r } = e;
            if (!R(r)) {
                const i = ke(e.borderRadius),
                    l = Se(e.backdropPadding);
                t.fillStyle = r;
                const h = s - l.left,
                    c = n - l.top,
                    d = o - s + l.width,
        ...
        function Xo(t, e, i, s) {
            const { ctx: n } = t;
            if (i) n.arc(t.xCenter, t.yCenter, e, 0, st);
            else {
        ...
        class qo extends Ro {
            ...
            setDimensions() {
                const t = (this._padding = Se(No(this.options) / 2)),
            ...
            generateTickLabels(t) {
                Ro.prototype.generateTickLabels.call(this, t),
                ...
                t.display && t.pointLabels.display
                    ? (function (t) {
                          ...
                          for (let d = 0; d < o; d++) {
                              ...
                              s[d] = g;
                              const p = Mt(t.getIndexAngle(d) + r),
                                  m = Math.round(bt(p));
                              jo(
                                  i,
                                  e,
                          ...
                          t.setCenterPoint(
                              ...
                              (t._pointLabelItems = (function (t, e, i) {
                                  const s = [],
                                      ...
                                      o = t.options,
                                      { centerPointLabels: a, display: r } =
                                          o.pointLabels,
                                      l = {
                                          extra: No(o) / 2,
                                          additionalAngle: a ? it / n : 0,
                                      };
                                  let h;
                                  for (let o = 0; o < n; o++) {
            ...
            getIndexAngle(t) {
                return Mt(
                    t * (st / (this._pointLabels.length || 1)) +
        ...
        function Jo(t, e) {
            ...
            return (
                ...
                F(a) || (a = "string" == typeof s ? i.parse(a, s) : i.parse(a)),
                null === a
                    ? null
                    : (n &&
                          (a =
        ...
        function Qo(t, e, i, s) {
            const n = Go.length;
            for (let o = Go.indexOf(t); o < n - 1; ++o) {
                const t = Ko[Go[o]],
        ...
        class ia extends Ns {
            ...
            init(t, e = {}) {
                const i = t.time || (t.time = {}),
                    s = (this._adapter = new Gi(t.adapters.date));
                s.init(e),
                    q(i.displayFormats, s.formats()),
                    (this._parseOpts = {
                        parser: i.parser,
                        round: i.round,
            ...
            parse(t, e) {
                return void 0 === t ? null : Jo(this, t);
            }
            beforeLayout() {
                super.beforeLayout(),
                    (this._cache = { data: [], labels: [], all: [] });
            ...
            determineDataLimits() {
                ...
                (o && a) ||
                    ...
                    ("ticks" === t.bounds && "labels" === t.ticks.source) ||
                        r(this.getMinMax(!1))),
                    (s = F(s) && !isNaN(s) ? s : +e.startOf(Date.now(), i)),
                    (n = F(n) && !isNaN(n) ? n : +e.endOf(Date.now(), i) + 1),
                ...
                return (
                    ...
                    (this._majorUnit =
                        i.major.enabled && "year" !== this._unit
                            ? (function (t) {
                                  for (
                                      let e = Go.indexOf(t) + 1, i = Go.length;
                                      e < i;
                                      ++e
                                  )
                                      if (Ko[Go[e]].common) return Go[e];
                              })(this._unit)
                            : void 0),
                    this.initOffsets(s),
                    t.reverse && o.reverse(),
                    ea(this, o, this._majorUnit)
                );
            }
            afterAutoSkip() {
            ...
            _generate() {
                const t = this._adapter,
                    ...
                    o =
                        n.unit ||
                        Qo(n.minUnit, e, i, this._getLabelCapacity(e)),
                ...
                for (c = u, d = 0; c < i; c = +t.add(c, a, o), d++) ta(h, c, f);
                return (
                    (c !== i && "ticks" !== s.bounds && 1 !== d) || ta(h, c, f),
                    Object.keys(h)
                        .sort(Zo)
                        .map((t) => +t)
                );
            ...
            getLabelTimestamps() {
                ...
                for (e = 0, i = s.length; e < i; ++e) t.push(Jo(this, s[e]));
        ...
        var na = Object.freeze({
            __proto__: null,
            CategoryScale: class extends Ns {
                static id = "category";
                ...
                parse(t, e) {
                    ...
                    return ((t, e) =>
                        null === t ? null : kt(Math.round(t), 0, e))(
                        (e =
                            isFinite(e) && i[e] === t
                                ? e
                                : (function (t, e, i, s) {
            ...
            TimeScale: ia,
            TimeSeriesScale: class extends ia {
                static id = "timeseries";
                static defaults = ia.defaults;
                constructor(t) {
                    super(t),
                        (this._table = []),
                        (this._minPos = void 0),
                ...
                getDecimalForValue(t) {
                    return (
                        (sa(this._table, t) - this._minPos) / this._tableRange
                    );
                }
                getValueForPixel(t) {
                    const e = this._offsets,
